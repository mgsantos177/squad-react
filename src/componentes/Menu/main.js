                            ...
                            <div id="mainnav-profile" className="mainnav-profile">
                                <div className="profile-wrap text-center">
                                    <div className="pad-btm">
                                        <img clclassNameass="img-circle img-md" src="img/profile-photos/1.png" alt="Profile" />
                                    </div>
                                    <a href="#profile-nav" className="box-block" data-toggle="collapse" aria-expanded="false">
                                        ...
                                        <p className="mnp-name">Matheus Gonçalves</p>
                                        <span className="mnp-desc">mgsantos177@gmail.com</span>
                                    </a>
                                </div>
                            ...
                            <ul id="mainnav-menu" className="list-group">
                                ...
                                <li className="active-sub">
                                    ...
                                    <ul className="collapse in">
                                        <li className="active-link"><a href="index.html">Dashboard 1</a></li>
